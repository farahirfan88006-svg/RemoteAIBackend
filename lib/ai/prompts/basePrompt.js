 ...
 * module, not here.
 */
export const BASE_SYSTEM_PREAMBLE =
 ...
 * @returns {string}
 */
export function buildSystemPrompt(featureInstructions) {
  const instructions =
 ...
 * @returns {string}
 */
export function buildUserPrompt(sections) {
 ...
 * @returns {string}
 */
export function wrapWithGuardrails(prompt) {
 ...
 */
export function composePrompt({ featureInstructions, sections } = {}) {
  return {
