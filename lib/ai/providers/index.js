 ...
 * openai.provider.js / gemini.provider.js / openrouter.provider.js /
 * groq.provider.js (each makes no API call — and reports
 * isAvailable() === false — until its corresponding *_API_KEY env var is
 * set). The older openaiProvider.js / geminiProvider.js files are left in
 * place, unused, as they were intentionally-unimplemented placeholders
 ...
 *
 * Available keys: 'free' | 'openai' | 'gemini' | 'openrouter' | 'groq'
 */
