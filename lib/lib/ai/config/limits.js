...
export const AI_FEATURES = Object.freeze({
  ...
  // Text-only, JSON-based AI features (src/controllers/ai/*, mounted under
  // /api/ai/*). Keys below MUST match the `FEATURE` constant used by each
  // route/controller pair exactly (resumeAnalyzer.routes.js, etc.) — these
  // are read by checkUsageLimit/incrementUsage via usageService.js.
